...
await Property.insertMany([
  { name: 'Hilo Hawaiian Hotel', 
    ...
    targetSegment: 'leisure travelers', 
    imageURL: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7_p1BrkgYdhFV4d1KNcEHQp9xfih4AoEcYw&s://example.com/hilo.jpg' },
  { name: 'Grand Naniloa Hotel', 
    ...
    imageURL: 'https://www.hilton.com/im/en/ITOHNDT/7507354/grand-naniloa-aerials-5-copy.jpg?impolicy=crop&cw=4600&ch=2575&gravity=NorthWest&xposition=0&yposition=436&rw=768&rh=430://example.com/grand-naniloa.jpg' },
  { name: 'Four Seasons Resort Hualalai', 
    ...
    targetSegment: 'luxury travelers', 
    imageURL: 'https://www.fourseasons.com/content/dam/fourseasons/images/web/KON/KON_2973_aspect16x9.jpg://example.com/four-seasons.jpg' },
  { name: 'Kona Village Resort', 
    ...
    targetSegment: 'leisure travelers', 
    imageURL: 'https://images.rosewoodhotels.com/is/image/rwhg/RWKVL_Accommodations_SignatureSuite_Maheawalu_Exterior_02.jpg:WIDE-MEDIUM-4-3://www.konavillageresort.com/images/hero/hero-1.jpg://example.com/kona-village.jpg' },
  { name: 'Volcano House', 
    island: 'Hawaii Island', 
    type: 'hotel', 
